              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <?php if(isset($_SESSION['notif'])){ ?>
                    ...
                    <i class=""><?php echo $_SESSION['notif']; unset($_SESSION['notif']);?></i>
                                                    
                    </p></center>
                  <?php } ?>

                  <form class="row g-3 needs-validation" method="POST" action="models/traitement-login.php?fonction=<?=$_GET['fonction']?>">
                    ...
                    <?php
                    if($_GET["fonction"]!="employer"){

                    
                    
                    ?>
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="compte.php">Create an account</a></p>
                    </div>
                    <?php 
                    }
                    ?>
