...
include('../models/select/sel-ventre.php');
...
<div class="card">
    <div class="card-body">
       ...
       <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12  col-sm-12">
              ...
              <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 mt-10 col-sm-12 p-3 aling-center">
                    <input type="submit" class="btn btn-warning w-100" name="newcommande" value="suivant">
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12  col-sm-12">
              ...
              <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                      ...
                      <input autocomplete="off" required type="text" class="form-control" placeholder="Ex:10" id="qte" min="1"  name="qte" <?php if(isset($id)){?> value="<?=$ModData['quanite']?>"<?php } ?>>   
                  </div>
          ...
          <?php }else{ ?>
              <a href="vendre.php?new" class="col-12 btn btn-outline-danger bi bi-plus">Ventre</a> 
              ...
              <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$PT?>$</td>
                        <td>
                            <a href="vendre.php?new&mod=<?=$data['id']?>" class="btn btn-dark btn-sm "><i
                             class="bi bi-pencil-square"></i></a>
                              <a onclick=" return confirm('Voulez-vous vraiment supprimer ?')"
                             href="../models/del/del-vendre.php?iddel=<?=$data['id'] ?>"
